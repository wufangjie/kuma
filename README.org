...
** Windows
1. psutil, to get application name, since windows's class name is casual
2. win32api
...
5. "Pattern" you can write a pattern to match window's appname or title, if empty use keyword instead
